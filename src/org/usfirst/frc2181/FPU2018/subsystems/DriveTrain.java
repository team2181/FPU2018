...
//SD        SmartDashboard.putData("PID Values", getPIDController());
        gyro.calibrate();
...
//SD        SmartDashboard.putData("Left Encoder", leftEncoder);
//SD        SmartDashboard.putData("Right Encoder", rightEncoder);
        setRamping(1.5);
...
//SD    	SmartDashboard.putNumber("PID Output", -output);
//SD    	SmartDashboard.putNumber("Test Vision Val", num);
    ...
    public void drive(Joystick j) {
    	double spd = -.75 * j.getRawAxis(1);
    	if (Math.abs(spd) < .1) {spd = 0;}
    	double rot = -.75 * j.getRawAxis(4);
    	double ramp = 1.5;
    	if (rot == 0 && spd == 0) {
    		ramp = 1.5;
    	} else {
...
//SD    	SmartDashboard.putNumber("Left Encoder D", leftMotor.getSelectedSensorVelocity(0));
//    	System.out.println(leftMotor.getSelectedSensorPosition(0));
//SD    	SmartDashboard.putNumber("Right Encoder D", rightMotor.getSelectedSensorVelocity(0));
    	SmartDashboard.putNumber("Gyro", gyro.getAngle());
//SD    	SmartDashboard.putNumber("Ultrasonic", ultrasonic.getRangeInches());
//SD    	SmartDashboard.putString("Mode", mode);
//SD    	SmartDashboard.putNumber("Joy Pos", spd);
...
//SD    	SmartDashboard.putBoolean("High V & Low T", gearShift.get());
    }
