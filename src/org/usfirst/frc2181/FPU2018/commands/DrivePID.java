...
//SD        SmartDashboard.putString("testing", "drive pid init done");
    ...
    protected boolean isFinished() {
        return Robot.driveTrain.onTarget() || Math.abs(Robot.driveTrain.getEncoder())>Math.abs(m_setpoint);
    }
