...
//        driveMode.whileHeld(new DriveSwitch());
        record = new JoystickButton(joystick, 10); //find out which number the 'start' button is on the xbox controller
        record.whenPressed(new RecordAuto());
