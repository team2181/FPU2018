 ...
 *
 */
public class AutoTimeBsdR extends CommandGroup {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
        ...
        addSequential(new TimeMove(0, .7, .42, 'R'));
        addSequential(new TimeMove(-.6, 0, 1, 'R'));
        addSequential(new AutoFlippyDoUp(.5, 'R'));
