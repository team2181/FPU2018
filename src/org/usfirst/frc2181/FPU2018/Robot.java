...
public class Robot extends TimedRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        chooser.addObject("Test Autonomus Left", new TestAutonomusLeft());
        chooser.addObject("AutoRecordedLeft", new AutoRecordedLeft());
        chooser.addObject("AutoRecordedMiddle", new AutoRecordedMiddle());
