...
//		_talon.config_kF(0, 0, Constants.kTimeoutMs);
//		_talon.config_kP(0, 0.6, Constants.kTimeoutMs);
//		_talon.config_kI(0, 0.01, Constants.kTimeoutMs);
//		_talon.config_kD(0, 60, Constants.kTimeoutMs);
...
//		_talon.config_kD(0, 60, Constants.kTimeoutMs);
    ...
    protected void initialize() {
    	if (m_profile == "left") {
    		_example = new MotionProfileExample(_talon, _talon2, GeneratedMotionProfile.PointsL1, GeneratedMotionProfile.PointsL2, GeneratedMotionProfile.kNumPointsL);
    		count = GeneratedMotionProfile.kNumPointsL;
    		...
    		count = GeneratedMotionProfile.kNumPointsR;
    	} else if (m_profile == "middle") {
    		String s;
    		s = DriverStation.getInstance().getGameSpecificMessage();
    		while (s == null) {
    			s = DriverStation.getInstance().getGameSpecificMessage();
    		}
    		if (DriverStation.getInstance().getGameSpecificMessage().charAt(0) == 'L') {
    			...
    			count = GeneratedMotionProfile.kNumPointsML;
    		} else {
    			...
    			count = GeneratedMotionProfile.kNumPointsMR;
    		}
    	} else if (m_profile == "stage2") {
    		String s;
    		s = DriverStation.getInstance().getGameSpecificMessage();
    		while (s == null) {
    			s = DriverStation.getInstance().getGameSpecificMessage();
    		...
    		if (DriverStation.getInstance().getGameSpecificMessage().charAt(0) == 'L') {
    			_example = new MotionProfileExample(_talon, _talon2, GeneratedMotionProfile.PointsSL1, GeneratedMotionProfile.PointsSL2, GeneratedMotionProfile.kNumPointsSL);
    			count = GeneratedMotionProfile.kNumPointsSL;
    		} else {
    			_example = new MotionProfileExample(_talon, _talon2, GeneratedMotionProfile.PointsSR1, GeneratedMotionProfile.PointsSR2, GeneratedMotionProfile.kNumPointsSR);
    			count = GeneratedMotionProfile.kNumPointsSR;
    		}
    	}
    ...
    protected boolean isFinished() {
    	if (timeSinceInitialized() >= count*.05) {
    		return true;
    	} else
    		return false;
    }
