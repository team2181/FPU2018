...
//	WPI_TalonSRX _talon2;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        //chooser.addObject("AutoStraightLeft", new AutoSL());
        chooser.addObject("AutoLeftSimple", new AutoLeftSimple());
        chooser.addObject("AutoMiddleSimple", new AutoSR());
        chooser.addObject("AutoRightSimple", new AutoRightSimple());
        chooser.addObject("AutoStraightOnly", new AutoStraight());
