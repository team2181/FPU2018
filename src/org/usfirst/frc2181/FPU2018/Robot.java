...
//	WPI_TalonSRX _talon2;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        chooser.addObject("Motion Profile Left", new AutoMtnProL());
        chooser.addObject("Motion Profile Right", new AutoMtnProR());
        chooser.addObject("Motion Profile Middle", new AutoMtnProM());
        chooser.addObject("Time Based Left", new AutoTimeBsdL());
        chooser.addObject("Time Based Middle", new AutoTimeBsdM());
        chooser.addObject("Time Based Right", new AutoTimeBsdR());
        chooser.addObject("Just Cross the Line", new AutoLineCross());
...
//SD        chooser2.addDefault("No", false);
//SD        chooser2.addObject("Yes", true);
//SD        SmartDashboard.putData("Go for it", chooser2);
...
//SD        SmartDashboard.putNumber("Vision XPos", avg);
        Scheduler.getInstance().run();
//SD    	double val = SmartDashboard.getNumber("Pos", 0);
//SD    		SmartDashboard.putNumber("Pos 2", 2.0*val);
    }
