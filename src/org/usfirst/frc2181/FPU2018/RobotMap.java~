...
public class RobotMap {
    ...
    public static DifferentialDrive driveTrainDiffDrive2;
    ...
    public static void init() {
        ...
        driveTrainRightMotor2 = new WPI_TalonSRX(4);
        
        
        driveTrainDiffDrive2 = new DifferentialDrive(driveTrainRightMotor2, driveTrainLeftMotor2);
        LiveWindow.addActuator("DriveTrain", "DiffDrive2", driveTrainDiffDrive2);
        driveTrainDiffDrive2.setSafetyEnabled(true);
        driveTrainDiffDrive2.setExpiration(0.1);
        driveTrainDiffDrive2.setMaxOutput(1.0);

        driveTrainGearShift = new Solenoid(1, 0);
        LiveWindow.addActuator("DriveTrain", "GearShift", driveTrainGearShift);
        
        flippyDooUltrasonic1 = new Ultrasonic(7, 6);
        LiveWindow.addSensor("FlippyDoo", "Ultrasonic 1", flippyDooUltrasonic1);
        
        flippyDooPusher = new Solenoid(0, 0);
